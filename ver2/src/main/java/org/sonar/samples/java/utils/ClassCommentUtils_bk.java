...
public class ClassCommentUtils_bk {
	...
	private enum Type {
		...
		static {
//
			INVALID_AUTHOR.errMsg = CommonMessage_bk.INVALID_AUTHOR_FORMAT;
			INVALID_SEE.errMsg = CommonMessage_bk.CLASS_INVALID_SEE_FORMAT;
			INVALID_SINCE.errMsg = CommonMessage_bk.CLASS_INVALID_SINCE_FORMAT;
			INVALID_LINE.errMsg = CommonMessage_bk.INVALID_LINE_FORMAT;
