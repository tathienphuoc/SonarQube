...
//	public static final String METHOD_ABSENT_COMMENTS = "Missing method comments]";
	...
	public static final String METHOD_INVALID_DESCRIPTION_FORMAT = "Description must end with <br>";
    ...
    public static final String METHOD_INVALID_LINE_FORMAT = "Line must start with one asterisk and one whitespace";
	...
	public static final String METHOD_REMOVE_EMPTY_LINE = "Please remove empty line";
	public static final String METHOD_REMOVE_EMPTY_LINE_WITHOUT_ASTERISK = "Please remove empty line without asterisk";
