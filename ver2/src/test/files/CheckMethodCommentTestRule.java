...
class MyClass {
	 ...
	 */
	private List<LongRangeSkdVO> loadSimDataList(LongRangeSkdGPVVO longRangeSkdGPVVO, int addCallPost, int addVvdPos,
			LongRangeSkdVO addPort, boolean addCancel) throws EventException;
