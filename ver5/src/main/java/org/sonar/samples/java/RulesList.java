...
import org.sonar.samples.java.checks.CheckNullDereferencingRule;
...
public final class RulesList {
	...
	public static List<Class<? extends JavaCheck>> getJavaChecks() {
		return Collections.unmodifiableList(Arrays.asList(CheckClassCommentRule.class, CheckMethodCommentRule.class,
				CheckFileCommentRule.class, CheckForbiddenStringEqualExpressionRule.class,
				CheckICWE209Rule.class/*
